...
- [GitLab repository](https://gitlab.com/kirbo/node12-rsync-python-ssh)
- [GitHub repository](https://github.com/kirbo/node12-rsync-python-ssh)
- [Docker repository](https://hub.docker.com/repository/docker/kirbownz/node12-rsync-python-ssh)
